...
trait HttpResponses 
{
    protected function success($data, $message = 'Request was successful.', $code = Response::HTTP_OK)
    {
    ...
    protected function updated($data, $message = 'Resource updated successfully.', $code = Response::HTTP_OK)
    {
        return response()->json([
            'message' => $message,
            'data' => $data
