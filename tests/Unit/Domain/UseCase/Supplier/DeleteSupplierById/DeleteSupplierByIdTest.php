...
class DeleteSupplierByIdTest extends TestCase
{
    ...
    #[TestWith([1])]
    # php artisan test --filter=DeleteSupplierByIdTest::test_execute_delete_supplier_by_id_throw_empty_data_exception
    public function test_execute_delete_supplier_by_id_throw_empty_data_exception(int $supplierId)
    {
        $supplierRepositoryMock = $this->createMock(ISupplierRepository::class);
