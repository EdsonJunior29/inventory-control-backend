...
class CreateUserTest extends TestCase
{
    ...
    {
        $inputData = new CreateUserInputData('John Doe', 'john@example.com', 'password123', Profiles::ADMIN);
    ...
    public function test_execute_return_user_null(): void
    {
        ...
        $inputData = new CreateUserInputData('John Doe', 'john@example.com',  'password123', Profiles::COLABS);
